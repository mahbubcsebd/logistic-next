                ...
                <Row className="align-items-center">
                    <Col lg={6}>
                        <div className="section-content">
                            <h2 className="section-title">We are the world leading Logistic service</h2>
                            <div className="trusted-img-box d-lg-none mb-4">
                                <Image src={leading} alt="leading" />
                            </div>
                            <p className="text">Our goal is to ensure that you have access to the most suitable
                                logistics solutions that optimize your supply chain
                                operations, reduce costs and meet your business needs. Our supply chain solutions team
                                provides detailed specifications.</p>
